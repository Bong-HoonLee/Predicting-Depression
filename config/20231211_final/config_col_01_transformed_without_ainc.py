...
config = {
    "name": "train_X_231211_final_col_01_transformed_without_ainc",
    "model": {
        "class": ANN,
    ...
    "data": {
        "train_X": {
            "path": "data/trn_X_20231211_final_col_01_transformed_without_ainc.csv",
            "index_col": None,
        },
        "train_y": {
            "path": "data/trn_y_20231211_final_col_01_transformed_without_ainc.csv",
            "index_col": None,
        },
        "test_X": {
            "path": "data/tst_X_20231211_final_col_01_transformed_without_ainc.csv",
            "index_col": None,
        },
        "test_y": {
            "path": "data/tst_y_20231211_final_col_01_transformed_without_ainc.csv",
            "index_col": None,
        },
        "transform": {
            "steps": [
